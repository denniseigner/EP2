...
public class Participation {
    ...
    // TODO: The object variables 'race', 'racer' and 'bibnumber' (Startnummer) shall be declared here.
    ...
    // Output the following (without newline at the start or end) for the Participation created by
    ...
    // Question:
    // Should there also be setter methods for the object variables?  Why or why not?
